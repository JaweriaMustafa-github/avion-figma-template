    ...
    <>
      <div className='px-6 md:px-12 py-8 bg-[#2A254B] mt-8'>
        <div className="flex flex-wrap gap-12 md:gap-8 lg:gap-20">
          ...
          {/* Categories Section */}
          <div className="text-white w-full h-[380px] sm:w-auto">
          ...
          <div className="text-white w-full sm:w-auto">
            ...
            <div className='mt-4'>
              <input
                ...
                className='w-full sm:w-[250px] lg:w-[500px] h-[56px] p-2 bg-transparent opacity-35 border border-white rounded-md'
              />
